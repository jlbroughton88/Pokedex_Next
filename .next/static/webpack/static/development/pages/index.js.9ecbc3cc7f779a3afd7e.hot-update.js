...
var Pokemon = function Pokemon(props) {
  ...
  var fetchData = function fetchData() {
    fetch("https://pokeapi.co/api/v2/pokemon/".concat(lowercaseFirstLetter(props.name))).then(function (res) {
      return res.json();
    }).then(function (data) {
      return setPokemon({
        id: data.id,
...
//# sourceMappingURL=index.js.9ecbc3cc7f779a3afd7e.hot-update.js.map